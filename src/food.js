...
const renderRandom = (random) => {
    ...
    card.classList.add("card")
        ...
        <div class="card-info">
            ...
            <p id="card-measure">${"Measurements: " + random.strMeasure1 + ", " + random.strMeasure2 + ", " + random.strMeasure3 + ", " + random.strMeasure4 + ", " + random.strMeasure5 + ", " + random.strMeasure6 + ", " + random.strMeasure7 + ", " + random.strMeasure8 + ", " + random.strMeasure9 + ", " + random.strMeasure10 + ", " + random.strMeasure11 + ", " + random.strMeasure12 + ", " + random.strMeasure13 + ", " + random.strMeasure14 + ", " + random.strMeasure15 + ", " + random.strMeasure16 + ", " + random.strMeasure17 + ", " + random.strMeasure18 + ", " + random.strMeasure19 + ", " + random.strMeasure20}</p>  
            </div>`
            sidebar.innerHTML = "";
        sidebar.append(card)
    }
